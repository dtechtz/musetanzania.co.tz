...
<div class="sidebar">
        ...
        <div class="main-containt">
            ...
            <div class="main-body-menus">
                ...
                <div class="palel-1">
                  ...
                  <div class="panel panel-primary">
                         <div class="panel-heading">
                             <span><h5><span style="color:  #ffff00; font-weight: bold">NEW EXPENSES ENTRY:</span></h5></span>
                         </div>
                    <div class="panel-1-body">
                        <div id="depositsms"></div> 
                      <form id="expense_new_ballance" class="expense_new_ballance">
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                            <label for="carrentballance" class="col-sm-2 col-form-label">Expenditure Date</label>
                            <div class="col-sm-6">
                                <input type="date" id="date1"  name="expdate" class="form-control"  autocomplete="off">
                                <span id="error_date1" class="text-danger"></span>
                            </div>
                          </div>
                        <div class="form-group row">
                            <label for="carrentballance"  class="col-sm-2 col-form-label">Withdraw Amount</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="carrentballance" class="col-sm-2 col-form-label">Account To Withdraw</label>
                            <div class="col-sm-6">
                          ...
                          <div class="form-group row">
                            <label for="carrentballance" class="col-sm-2 col-form-label"> Expenses Category</label>
                                 <div class="col-sm-6">
                                     <select name="expcate" id="category" class="form-control">
                          ...
                          <div class="form-group row">
                            <label for="carrentballance" class="col-sm-2 col-form-label"> Description</label>
                                 <div class="col-sm-6">
                                     <textarea rows="6" cols="40" id="desc" name="desc1" class="form-control"></textarea>
                            </div>
              ...
              <script>
                  $(document).ready(function(){
                        $('#expense_new_ballance').on('submit',function(){
                        ...
                        if($.trim($('#date1').val()).length === 0){
                            error_date1 = 'Please Expense date';
                         ...
                         if($.trim($('#AC').val()).length === 0){
                            error_AC = 'Please Select account';
                        ...
                        if(error_date1 !=='' || error_amount !==''|| error_AC !==''|| error_category  !==''){
                            ...
                            return false;
                             ...
                             $.ajax({
                                  url:'controller.jsp?page=expenses&operation=update_balance',
                                  methode:'POST',
                                  data:$('#expense_new_ballance').serialize(),
