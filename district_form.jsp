...
<div class="sidebar">
        ...
        <div class="main-containt">
          ...
          <div class="uder-header">
            ...
            <div class="main-body-menus">
                <div class="palel-1">
                  <div class="panel-1-header">
                        ...
                        <input type="submit" id="savetest" name="savetest" class="btn btn-success" value="Create New District" data-toggle="modal" data-target="#crdistrict" style="float: right">
                    </div>
                    <div class="panel-1-body">
                      <div class="box">
                         <table id="table" class="table">
                                    ...
                                    <th>#</th>
                                    <th>Country Name</th> 
                                    <th style="width: 30%">Regional Name</th> 
                                    <th style="width: 30%">District Name</th>
                                    <th>Action</th>
                                    </thead>
                                    <tbody>
                                        <%
                                        ArrayList list1 = AD.Print_District();
                                        for(int i =0; i<list1.size(); i++){
                                          district ds = (district)list1.get(i);
                                        %>
                                        <tr>
                                            <td></td>
                                            <td><%=ds.getCountryName()%></td>
                                            <td> <%=ds.getRegionalName()%></td>
                                            <td><%=ds.getDistrict()%></td>
                                            <td>
            ...
            <div id="crdistrict" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         ...
                         <form method="POST" id="create_district">
                             <div id="dissms"></div>
                             <div class="form-group">
                                 <label>Regional Name</label>
                             <select id="newregional" name="regid" class="form-control">
                                 <option value="">[ Select Regional Name ]</option>
                                 <%
                             ...
                             <div class="form-group">
                              ...
                              <input type="text" name="newdistrict" autocomplete="off" id="newdistrict" class="form-control">
                             <span class="error_form" id="district_error_message" style=" color:  #cc0000"></span> 
                             </div>
 ...
 <script>
    ...
    $("#create_district").on('submit',function(){
          ...
          if(error_regional === false ){
            $.ajax({
                url:'controller.jsp?page=setting&operation=add_district',
                methode:'POST',
                data:$(this).serialize(),
