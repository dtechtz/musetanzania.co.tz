...
<div class="sidebar">
            ...
            <div class="main-body-2">
                <div class="palel-1">
                  <div class="panel-1-header">
                        <span>CREATE NEW EXPENDITURE  CATEGORY</span>  
                    </div>
                    
                    <div class="panel-1-body">
                        <div id="catesms"></div>
                        <form id="category_mode_setting6">
                        ...
                        <div class="form-group">
                           ...
                           <span id="error_desc" class="text-danger"></span>
                            ...
                            <input type="submit" id="create" value="Create New Expenses Category" class="btn btn-success form-control">
                     </form>      
       ...
       $('#category_mode_setting6').on('submit', function(){
        ...
        if(error_type !=='' || error_desc !==''){
            ...
            return false;
                        ...
                        $.ajax({
                            url:"controller.jsp?page=setting&operation=expense_category",
                            methode:"POST",
                            data:$('#category_mode_setting6').serialize(),
                            ...
                            success: function(data){
                                ...
                                setTimeout(function()
                                {
                                 ...
                                 $('#create').val("Create New Expenses Category");
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <div class="rt">
                                        <ul>
                                            <li><span>ID: &nbsp;&nbsp;::&nbsp;&nbsp;</span><span class="typeid"><%=mb.getCategoryID()%></span></li>
                                            <li><span>Category Name:&nbsp;&nbsp;::&nbsp;&nbsp;</span><span class="type_loan"> <%=mb.getCategoryName()%></span></li>
                                            <li><span>Description:&nbsp;&nbsp;::&nbsp;&nbsp;</span><small class="type_desc"><%=mb.getCategoryDescription()%></small></li>
                                    ...
                                    <td style="width: 31%">
                                        <a href="#" data-toggle="modal"  data-target="#loan_type_edit" class="btn btn-warning loan_type_edit_new"><span class="fa fa-pencil-square-o">&nbsp;&nbsp;Edit</span></a>
                                         <a href="controller.jsp?page=setting&operation=Delete_Expenses_Category&code=<%=mb.getCategoryID()%>"  class="btn btn-danger" onclick="return confirm('Please Do not delete if you are not sure for what you do, you advised to Edit for more safe records');"><span class="fa fa-trash">&nbsp;&nbsp;Remove</span></a>
                                    </td>
                                </tr>
                                <%}%>
        ...
        $(document).ready(function(){
            ...
            $('#update_loan_type_new').on('submit', function(){
                event.preventDefault();
                $.ajax({
                    url:'controller.jsp?page=setting&operation=Edit_Expenses_category',
                    methode:'POST',
