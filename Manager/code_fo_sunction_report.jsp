       ...
       String  enddate = request.getParameter("enddate");
        ...
        try {
           ...
           // pst.setString(1, Name);
            rs = pst.executeQuery();
             %>
<p style="color: #006666; padding: 1rem; font-weight: bold; background: #f0f0f0" > GROUP  MEMBER WAITING FOR DISBURSEMENT <span style="float: right"> <a href="PDF.jsp?Report=groupsanction&startdate=<%=startdate%>&enddate=<%=enddate%>" target="_black" class="btn btn-success"><span class="fa fa-download">&nbsp;&nbsp;Generate Printable Report</span></a></span></p>
...
<%
        ...
        try {
           ...
           // pst.setString(1, Name);
            rs = pst.executeQuery();
             %>
<p style="color: #006666; padding: 1rem; font-weight: bold; background: #f0f0f0" > INDIVIDUAL MEMBER WAITING FOR DISBURSEMENT<span style="float: right"> <a href="PDF.jsp?Report=membersanction&startdate=<%=startdate%>&enddate=<%=enddate%>" target="_black" class="btn btn-success"><span class="fa fa-download">&nbsp;&nbsp;Generate Printable Report</span></a></span></p>
