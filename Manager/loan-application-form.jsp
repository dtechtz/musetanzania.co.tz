                  ...
                  <div class="panel-1-header">
                     ...
                     <div class="panel-1-header">
                             ...
                             <h4> Loan Application Sent Successfully</h4>
                               ...
                               <span style=" text-align: center; color: #006666">
                                   <h4 style="background: red; color:  #ffffff"> You have to pay All loan you given before request new</h4>
                              </span>
                             <%}%>
                      </div>
                    <div class="panel-1-body">
                        <form action="controller.jsp">
                            <input type="hidden" name="page" value="loan_giving">
                            ...
                            <tr>
                              ...
                              <td>
                                  <select name="borrower" class="text" required>
                                    <option ></option>
                                    <option  style="background:  #0099cc; color:  #ffffff">Please select here </option>
                                <%
                                     ArrayList list2=AD.PrintMemberDetails();
                           ...
                           <tr>
                            ...
                            <tr>
                               ...
                               <td><input type="text" name="amount" class="text" placeholder="Amount..." id="number1" autocomplete="off" required></td>
                           </tr>
                            <tr>
                               <td><label>Application Date</label></td>
                               <td><input type="text" name="date"  readonly="true" class="text" placeholder=" Date applied for loan" autocomplete="off" id="datepicker" required></td>
                           </tr>
                           <tr>
                             <tr>
